...
function dind::ensure-downloaded-kubectl {
  ...
  case "${LOCAL_KUBECTL_VERSION}" in
    ...
    v1.7)
      ...
      kubectl_sha1_linux=819010a7a028b165f5e6df37b1bb7713ff6d070f
      kubectl_sha1_darwin=e6b701df185d0b43a325c5e65ec19c1ca7adea73
      ;;
    "")
      return 0
      ;;
...
function dind::do-run-e2e {
  ...
  docker run \
         ...
         go run hack/e2e.go -- -v --test ${check_version_skew_arg}=false --test_args='${test_args}'"
}
